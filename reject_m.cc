...
rejectMessage& rejectMessage::operator=(const rejectMessage& other)
{
...
class rejectMessageDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    rejectMessageDescriptor();
    virtual ~rejectMessageDescriptor();
...
Register_ClassDescriptor(rejectMessageDescriptor)

rejectMessageDescriptor::rejectMessageDescriptor() : omnetpp::cClassDescriptor("rejectMessage", "omnetpp::cMessage")
{
    propertynames = nullptr;
}

rejectMessageDescriptor::~rejectMessageDescriptor()
{
    delete[] propertynames;
}

bool rejectMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<rejectMessage *>(obj)!=nullptr;
}

const char **rejectMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *rejectMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *rejectMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *rejectMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int rejectMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *rejectMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string rejectMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool rejectMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *rejectMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
